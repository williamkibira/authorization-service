...
from app.core.logging.loggers import LoggerMixin, LogEntryProcessor


class ResourceLogger(LoggerMixin):
    """
        CAVEATS:
    ...
    def __init__(self):
        super(ResourceLogger, self).__init__()
    ...
    def process_request(self, req: falcon.Request, _: falcon.Response) -> None:
        ...
        if req.path not in self._excluded_resources:
            ...
            if req.content_length:
                req.context['body_json'] = simplejson.load(req.bounded_stream)
